...
const Cart = () => {
  const { cartWithProducts, cartTotal, deliveryFee, totalItemsInCart, updateCartQuantity, removeFromCart, user } = useContext(ShopContext);
          ...
          <div className="cart-content">
            ...
            <div className="cart-summary card">
              ...
              <div className="cart-summary-row">
                <span>Shipping <span style={{fontSize: '0.8rem', display: 'block', color: 'var(--text-secondary)'}}>(Based on selected products)</span></span>
